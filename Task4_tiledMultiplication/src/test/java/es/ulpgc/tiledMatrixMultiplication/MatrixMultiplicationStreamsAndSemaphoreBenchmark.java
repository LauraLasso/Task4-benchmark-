...
@State(Scope.Thread)
public class MatrixMultiplicationStreamsAndSemaphoreBenchmark {
    MatrixMultiplier multiplierAtomicIntegerAndSemaphores = new MatrixMultiplierWithSemaphore();
    ...
    public List<int[][]> testMatrixMultiplicationWithCompleteFuture() throws ExecutionException, InterruptedException {
        return multiplierAtomicIntegerAndSemaphores.multiplyMatrix(matrixABlocks, matrixBBlocks);
    }

    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
                .include(MatrixMultiplicationStreamsAndSemaphoreBenchmark.class.getSimpleName())
                .forks(1)
                .build();
