...
@State(Scope.Thread)
public class MatrixMultiplicationStreamsBenchmark {

    MatrixMultiplier multiplierStreams = new MatrixMultiplierWithStreams();
    ...
    @Benchmark
    public List<int[][]> testMatrixMultiplicationWithStreams() throws ExecutionException, InterruptedException {
        return multiplierStreams.multiplyMatrix(matrixABlocks, matrixBBlocks);
    }

    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
                .include(MatrixMultiplicationStreamsBenchmark.class.getSimpleName())
                .forks(1)
                .build();
